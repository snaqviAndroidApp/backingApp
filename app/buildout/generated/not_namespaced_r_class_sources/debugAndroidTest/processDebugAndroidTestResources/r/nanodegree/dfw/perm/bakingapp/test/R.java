...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha nanodegree.dfw.perm.bakingapp.test:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority nanodegree.dfw.perm.bakingapp.test:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts nanodegree.dfw.perm.bakingapp.test:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy nanodegree.dfw.perm.bakingapp.test:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout nanodegree.dfw.perm.bakingapp.test:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage nanodegree.dfw.perm.bakingapp.test:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery nanodegree.dfw.perm.bakingapp.test:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font nanodegree.dfw.perm.bakingapp.test:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle nanodegree.dfw.perm.bakingapp.test:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings nanodegree.dfw.perm.bakingapp.test:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight nanodegree.dfw.perm.bakingapp.test:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex nanodegree.dfw.perm.bakingapp.test:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:font
     */
     ...
     * </table>
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name nanodegree.dfw.perm.bakingapp.test:ttcIndex
     */
